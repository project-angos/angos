...
- Rules that return a non-boolean value (e.g., a string or integer) are treated as misconfigured and immediately deny the request (fail-closed) in both `allow` and `deny` mode
